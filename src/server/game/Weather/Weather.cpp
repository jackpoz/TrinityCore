...
bool Weather::ReGenerate()
{
    ...
    TC_LOG_INFO("misc", "Generating a change in %s weather for zone %u.", seasonName[season], m_zone); //-V557
    ...
    uint32 chance1 = m_weatherChances->data[season].rainChance; //-V557
    uint32 chance2 = chance1+ m_weatherChances->data[season].snowChance; //-V557
    uint32 chance3 = chance2+ m_weatherChances->data[season].stormChance; //-V557
