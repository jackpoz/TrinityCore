...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_ANTICHEAT_SPEED_HACK,
    CONFIG_ANTICHEAT_FLY_HACK,
    CONFIG_ANTICHEAT_TELEPORT_HACK,
    CONFIG_ANTICHEAT_JUMP_HACK,
    CONFIG_ANTICHEAT_CLIMB_HACK,
    CONFIG_ANTICHEAT_ZAXIS_HACK,
    CONFIG_ANTICHEAT_WATERWALK_HACK,
...
enum WorldFloatConfigs : uint32
{
    ...
    // AntiCheat System
    CONFIG_ANTICHEAT_TOLERANCE,
    CONFIG_ANTICHEAT_MAXSLOPE,
...
enum WorldIntConfigs : uint32
{
    ...
    // Nemesis Anticheat Ints
    CONFIG_ANTICHEAT_RESET_TIMER,
    CONFIG_ANTICHEAT_HACK_COUNTER,
